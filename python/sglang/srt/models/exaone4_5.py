...
class Exaone4_5_VisionPatchMerger(nn.Module):
...
class Exaone4_5_VisionTransformer(nn.Module, RotaryPosMixin):
    ...
    def __init__(
        ...
        num_kv_heads: int = vision_config.num_key_value_heads
        ...
        self.merger = Exaone4_5_VisionPatchMerger(
...
class Exaone4_5_ForConditionalGeneration(nn.Module):
    ...
    def __init__(
        ...
        if not self.config.encoder_only:
            ...
            # Exaone4Model.get_input_embeddings requires input_ids, but
            # general_mm_embed_routine expects a no-arg version returning the layer.
    ...
    def forward(
        ...
        """Run forward pass for Exaone4_5.
